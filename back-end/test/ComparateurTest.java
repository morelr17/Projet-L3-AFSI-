...
public class ComparateurTest {
	private final static String xmlMFC = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
	...
	protected Comparateur comparateur;
	List<String> listeVide = new ArrayList<>();
	List<String> lesActeursBpmn=new ArrayList<>() ;
	List<String> lesFluxBpmn=new ArrayList<>() ;
	List<String> lesActeursMfc=new ArrayList<>() ;
	List<String> lesFluxMfc=new ArrayList<>() ;
	
	@BeforeEach 
	public void init() throws SAXException, IOException, ParserConfigurationException { 
		comparateur= new Comparateur(); 
		lesActeursBpmn.add("user1"); lesActeursBpmn.add("user2");
		lesFluxBpmn.add("F01:Facture"); lesFluxBpmn.add("F02:Recu");
		lesActeursMfc=lesActeursBpmn;
		lesFluxMfc=lesFluxBpmn;
	}
    /**
     ...
     */
	@Test 
	public void testInit() throws SAXException, IOException, ParserConfigurationException {
		List<String> l = new ArrayList<>();
		assertEquals(l,comparateur.getFlBpmn());
		assertEquals(l,comparateur.getActBpmn());
		assertEquals(l,comparateur.getFlMfc());
		assertEquals(l,comparateur.getActMfc());
	}
	
	
	
	/**
	 * Test if the function when they are a diffirence between list
	 */
	@Test 
	public void diffOfAllWhenDifferenceExisteTest (){
		List<String> l1=new ArrayList<>();
		List<String> l2,l3;
		List<String> l4=new ArrayList<>();
		List<String> listDiffOfAll=new ArrayList<>();
		l1.add("aa"); l2=l1;l3=l2; l4.add("cc");
		listDiffOfAll.add("aa");	listDiffOfAll.add("cc");
		assertEquals(listDiffOfAll,comparateur.diffAll(l1,l2,l3,l4, ""));
		
	} 
	
	
	/**
	 * Test if the function diffAll when they are no diffirence
	 */
	@Test 
	public void diffOfAllWhenDifferenceNotExisteTest (){
		List<String> l1=new ArrayList<>();
		l1.add("tester");
		List<String> l2=l1;
		List<String> l3=l2;
	...
	/**
	 * Test if the function doMetier parse the actors and flux
	 */
	@Test 
	public void comparateurBpmnTest (){
		comparateur.doMetier(xmlBPMN,xmlMFC, "");
		assertEquals(lesActeursBpmn,comparateur.getActBpmn());
		assertEquals(lesFluxBpmn,comparateur.getFlBpmn());
